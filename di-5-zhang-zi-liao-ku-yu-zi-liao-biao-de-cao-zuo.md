...
"003" "螢幕" 300
"003" "螢幕" 300 <==錯
所以一定要有Key值，最好單欄為key，但有時必須多欄為Key
Key可能有一個以上
```
```text
* 2.欄位不要重復

prno  prna   qty   prodno prname
----- ------ ----- ------ ------
"001" "電腦" 100   "001"  "電腦"
"002" "鍵盤" 200   "002"  "鍵盤"
"003" "螢幕" 300   "003"  "螢幕"
...
prno  prna   qty   Accno  Accname
----- ------ ----- ------ ------
"001" "電腦" 100   "4101"  "營業收入"
"002" "鍵盤" 200   "4101"  "營業收入"
"003" "螢幕" 300   "4101"  "營業收入"
後一欄是多餘的，Accno足夠找到科目名稱

* 第三點因為效能與節省程式碼的原因，程式人員常常做不到...
```
...
表頭檔(單號，日期，客戶編號，銷售額，稅額，合計)
表身檔(單號，項次，品號，品名，數量，單價，金額 )

* 職務上有系統分析師與資料庫師，沒有的話程式就直接兼職
* 資料表利用外鍵值與其他資料表發生聯繫使用Key，互相找來找去..
```
